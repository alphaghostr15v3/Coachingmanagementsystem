...
<div class="mb-4 animate__animated animate__fadeIn">
    ...
    <h2 class="fw-bold">Modify Faculty Profile</h2>
</div>
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm animate__animated animate__fadeInUp">
            <div class="card-body p-4 p-md-5">
                <form action="{{ route('coaching.teachers.update', $teacher) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="staff_type" id="staff_type" class="form-select form-select-lg border-0 bg-light rounded-4" required>
                                <option value="Teaching" {{ old('staff_type', $teacher->staff_type) == 'Teaching' ? 'selected' : '' }}>Teaching</option>
                                <option value="Non-Teaching" {{ old('staff_type', $teacher->staff_type) == 'Non-Teaching' ? 'selected' : '' }}>Non-Teaching</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-5">
                        ...
                        <button type="submit" class="btn btn-primary px-5 py-2 rounded-4 fw-bold shadow">
                            <i class="fas fa-sync-alt me-2"></i> Update Faculty
                        </button>
                    </div>
                </form>
            </div>
