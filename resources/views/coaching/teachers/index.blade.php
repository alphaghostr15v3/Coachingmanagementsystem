...
<div class="d-flex justify-content-between align-items-center mb-4 animate__animated animate__fadeIn">
    <div>
        ...
        <p class="text-muted small">Manage teacher profiles, departments, and designations.</p>
    </div>
    <div class="d-flex gap-2">
        ...
        <a href="{{ route('coaching.teachers.create') }}" class="btn btn-primary rounded-pill shadow-sm px-4">
            <i class="fas fa-plus me-2"></i> Add Teacher Member
        </a>
    </div>
</div>
            ...
            <table class="table table-hover align-middle" id="teachersTable">
                ...
                <tbody>
                    ...
                    <tr class="animate__animated animate__fadeInUp" style="animation-delay: {{ $loop->iteration * 0.05 }}s">
                        ...
                        <td>
                            <div class="fw-bold small">{{ $teacher->designation->title ?? 'Teacher' }}</div>
