...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4 d-print-none">
        <a href="{{ route('teacher.salary-slips.index') }}" class="btn btn-outline-secondary rounded-pill px-4">
            <i class="fas fa-arrow-left me-2"></i> Back to Slips
        </a>
        <div class="d-flex gap-2">
            <a href="{{ route('teacher.salary-slips.download', $salarySlip->id) }}" class="btn btn-outline-danger shadow-sm rounded-pill px-4">
                ...
                <tr>
                    <td class="w-50 align-top">
                        <table class="detail-table w-100">
                            ...
                            <tr><td class="fw-bold-dark">{{ $salarySlip->teacher->name ?? 'N/A' }}</td></tr>
                            <tr><th>Email</th></tr>
                            <tr><td>{{ $salarySlip->teacher->email ?? 'N/A' }}</td></tr>
