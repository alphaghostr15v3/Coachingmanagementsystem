                ...
                <table class="table table-hover align-middle" id="salarySlipsTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('teacher.salary-slips.show', $slip->id) }}" class="btn btn-sm btn-primary rounded-pill px-3 me-1">
                                    <i class="fas fa-eye me-1"></i> View
                                </a>
                                <a href="{{ route('teacher.salary-slips.download', $slip->id) }}" class="btn btn-sm btn-outline-danger rounded-pill px-3">
